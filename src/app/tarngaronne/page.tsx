...
const getLabelColor = (categorie: SiteTG['categorie']): string => {
...
export default function TarnGaronneMapPage() {
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      ...
      <h1 className="text-3xl font-extrabold mb-6">🌳 Sites touristiques du Tarn-et-Garonne sur la carte</h1>
      ...
      >
        ...
        {isReady && sitesData.length === 0 && !isLoadingData && <p>Aucune donnée à afficher.</p>}
      </div>
      ...
      <table style={{ width: "100%", borderCollapse: "collapse", marginTop: "20px" }}>
        <thead style={{ backgroundColor: "#e0e0e0" }}>
          <tr>
            ...
            <th style={th}>Monument ou site</th>
        ...
        <tbody>
          {sitesData.map((site, i) => (
            <tr key={site.id} style={{ backgroundColor: i % 2 === 0 ? "#fff" : "#f9f9f9" }}>
              <td style={td}>{i + 1}</td>
