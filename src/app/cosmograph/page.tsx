...
if (!title) return "[https://via.placeholder.com/400x200?text=Cosmograph](https://via.placeholder.com/400x200?text=Cosmograph)";
const lower = title.toLowerCase();
if (lower.includes("ciné") || lower.includes("cinema") || lower.includes("film")) return "[https://via.placeholder.com/400x200?text=Ciné](https://via.placeholder.com/400x200?text=Ciné)";
return "[https://via.placeholder.com/400x200?text=Cosmograph](https://via.placeholder.com/400x200?text=Cosmograph)";
};
...
return ( <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8"> <h1 className="text-3xl font-bold mb-4">Événements American Cosmograph</h1> <p className="text-muted-foreground mb-6">
Événements filtrés depuis le site officiel d’American Cosmograph. </p>
      ...
      {filteredEvents.map(ev => (
        <div key={ev.id} className="bg-white shadow rounded overflow-hidden flex flex-col h-[480px]">
          ...
          <div className="p-3 flex flex-col flex-1">
            ...
            {ev.date && <p className="text-sm text-blue-600 font-medium mb-1">{formatDate(ev.date)}</p>}
