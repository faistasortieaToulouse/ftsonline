    ...
    <main className="max-w-7xl mx-auto p-6 bg-slate-50 min-h-screen my-10 shadow-2xl rounded-2xl border border-slate-200">
      ...
      <header className="mb-16 border-b-4 border-red-600 pb-8">
        <h1 className="text-8xl font-black text-slate-900 tracking-tighter uppercase">
          USA<span className="text-red-600">.</span>
        </h1>
        <p className="text-slate-500 font-mono mt-2 font-bold uppercase tracking-widest">United States Population Census 2026</p>
      ...
      <section className="mb-24">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h2 className="text-4xl font-black uppercase tracking-tighter">États Fédérés (Tri par Population)</h2>
        </div>
