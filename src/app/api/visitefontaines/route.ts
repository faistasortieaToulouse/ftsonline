...
const fontainesData: Fontaine[] = [
    ...
    },
    {
        ...
        details: "Quatorze jets d'eau (les musiciens) applaudissent le poète Nougaro qui marche sur la dalle noire (la scène). Le jet majeur est le 'do', la lumière est le 'dièse'. Elle évoque la résurrection de la vie artistique du maestro (2013).",
    },
    {
        id: 39,
