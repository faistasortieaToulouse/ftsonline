...
const museesHP: MuseeHP[] = [
  ...
  { commune: 'Maubourguet', nom: 'Musée archéologique du Val d\'Adour', adresse: '65700 Maubourguet', categorie: 'Patrimoine/Archéologie', url: 'https://www.tourisme-occitanie.com/musee-archeologique-du-val-dadour/maubourguet/tabid/37151/offreid/742b71fc-7b83-4a00-911e-7b71f92e2e8b/detail.aspx', lat: 43.5350, lng: 0.0200 },
  ...
  { commune: 'Lourdes', nom: 'Château-fort et musée pyrénéen de Lourdes (Ancien nom: Château de Soum)', adresse: '65100 Lourdes', categorie: 'Patrimoine/Histoire', url: 'http://www.lourdes-chateaufort.com/', lat: 43.1000, lng: -0.0460 },
