...
export default function MeetupEventsPage() { 
  ...
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold mb-4">Évènements de Meetup Toulouse colocation logement hebergement emploi job stage café des langues</h1>
      
      <p className="text-muted-foreground mb-6">
        Prochains événements du groupe Meetup Toulouse colocation logement hebergement emploi job stage café des langues, sur 31 jours.
      </p>
