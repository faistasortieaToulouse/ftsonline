...
export default function MuseeHeraultPage() {
  ...
  if (error) return <div className="p-10 text-sky-600 text-center font-bold italic">Erreur : {error}</div>;
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-slate-50 min-h-screen">
      ...
      <header className="mb-6">
        <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 leading-tight italic">🏖️ Musées de l'Hérault (34)</h1>
        <p className="text-slate-600 mt-1 font-medium italic">
          {isLoadingData ? 'Chargement...' : `${filteredMusees.length} lieux culturels entre mer et garrigue.`}
        </p>
      </header>
      ...
      <div className="relative mb-6">
        ...
        <input 
          type="text"
          placeholder="Rechercher à Montpellier, Béziers, Sète..."
        ...
        <table className="w-full text-left border-collapse text-sm">
          <thead className="bg-slate-50 border-b border-slate-200 text-slate-500 uppercase font-bold text-[11px]">
            <tr>
              ...
              <th className="p-4 w-20 text-center">Lien</th>
            </tr>
          </thead>
