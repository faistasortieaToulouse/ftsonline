  ...
  return (
    <div className="max-w-7xl mx-auto p-4 bg-slate-50 min-h-screen">
      ...
      <header className="mb-6">
        <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 leading-tight italic">🍷 Musées et Patrimoine du Lot (46)</h1>
        <p className="text-slate-600 mt-1 font-medium italic">
          {isLoadingData ? 'Chargement...' : `${filteredMusees.length} sites culturels en Quercy.`}
        </p>
      </header>
      ...
      <div className="relative mb-6">
        ...
        <input 
          type="text"
          placeholder="Rechercher à Cahors, Figeac, Rocamadour..."
