          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-12 text-center text-indigo-300 italic">Analyse des inégalités en cours...</td>
                  </tr>
                  ...
                  <tr key={item.rang} className="hover:bg-indigo-50/30 transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] text-slate-400 uppercase font-bold md:hidden">Malus points</span>
                      </div>
                    </td>
