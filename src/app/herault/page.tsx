...
const HERAULT_CENTER: [number, number] = [43.61, 3.87]; // Centré proche de Montpellier / Cœur Hérault

// --- Couleurs thématiques ---
const getThemeColor = (categorie: SiteHerault['categorie']): string => {
  switch (categorie) {
...
export default function HeraultMapPage() {
  ...
  useEffect(() => {
    async function fetchSites() {
      try {
        ...
        // Normalisation des catégories (Majuscule) pour correspondre au type
  ...
  // 2. Initialisation de la carte (Leaflet dynamique)
  useEffect(() => {
  ...
  return ( 
    <div className="p-4 max-w-7xl mx-auto"> 
      ...
      <h1 className="text-3xl font-extrabold mb-6">🌊 Patrimoine de l'Hérault</h1> 
...
// --- Styles identiques à la page Aude ---
