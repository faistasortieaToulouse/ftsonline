...
/* =========================
    LOGIQUE LAYOUT
========================= */
function calculLayout(noeud: NoeudSunniteMaghreb, x: number, y: number, positions: Position[]): number {
...
export default function HierarchieSunniteMaghrebPage() {
  ...
  useEffect(() => {
    fetch("/api/hierarchieSunniteMaghreb")
      ...
      .then((data: NoeudSunniteMaghreb[]) => {
        ...
        // Transformation en chaîne linéaire pour l'aspect "Chemin du Savoir"
  ...
  return (
    <main className="p-4 md:p-8 min-h-screen bg-[#fcfdfa]">
      ...
      {/* HEADER TYPE "MANUSCRIT DU MAGHREB" */}
      <header className="mb-16 text-center max-w-4xl mx-auto">
        <div className="flex justify-center mb-4">
          <Moon size={50} className="text-emerald-700 opacity-80" />
        </div>
        ...
        <p className="text-emerald-600 font-serif italic text-lg uppercase tracking-[0.2em] text-sm">
          Hiérarchie Sunnite du Grand Maghreb
        </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-8 items-start">
          ...
          >
            <div className="bg-emerald-50/50 border-b border-emerald-100 p-5 flex items-center gap-3">
              ...
              <h3 className="text-emerald-900 font-black uppercase text-xs tracking-widest">Le Protocole des Oulémas</h3>
            </div>
      ...
      <footer className="mt-12 text-center text-[10px] text-slate-400 uppercase tracking-[0.3em]">
        Patrimoine du Maghreb — Tradition et Jurisprudence
      </footer>
    </main>
  );
}