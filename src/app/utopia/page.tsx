...
export default function UtopiaPage() {
  ...
  async function fetchEvents() {
    ...
    setError(null);
    try {
      const res = await fetch("/api/utopia");
  ...
  return (
    <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold mb-4">Nouvelles Utopia Borderouge</h1>
      <p className="text-muted-foreground mb-6">
        Événements filtrés depuis le flux officiel d’Utopia Borderouge.
      </p>
