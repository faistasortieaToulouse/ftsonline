...
export default function DynastieTablePage() {
  ...
  const scroll = (direction: 'left' | 'right') => {
    if (scrollContainerRef.current) {
      ...
      // On augmente un peu la distance de défilement pour plus de confort (500px)
    ...
    <div className="min-h-screen bg-gray-50 p-4 font-sans">
      ...
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-gray-500 uppercase tracking-widest text-sm font-bold italic">Tableau de bord historique</p>
        </header>
