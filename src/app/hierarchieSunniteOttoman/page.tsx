      ...
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[1fr_420px] gap-8 items-start">
          ...
          <section 
            ...
            className="order-1 xl:order-1 bg-white border border-amber-100 rounded-3xl shadow-xl flex flex-col overflow-hidden"
          >
          ...
          <section 
            style={{ height: `${hauteurAffichee}px` }}
            className="order-2 xl:order-2 bg-amber-900/5 border-2 border-amber-100 rounded-3xl p-6 overflow-auto shadow-inner relative"
          >
