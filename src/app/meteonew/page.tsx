...
export default function MeteoNewPage() {
  ...
  if (error) return <div className="p-10 text-center text-red-500 font-bold">Erreur de chargement des prévisions.</div>;
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8 text-center md:text-left">
          <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">
            Prévisions Toulouse <span className="text-indigo-600">7 Jours</span>
          </h1>
          <p className="text-slate-500 mt-2 text-sm italic">
             Indicateurs de vigilance & Rayonnement UV
          </p>
        </header>
        ...
        {loading && (
          <div className="mt-20 text-center animate-pulse">
            <p className="text-slate-400 font-bold tracking-widest uppercase text-xs">Calcul des prévisions en cours...</p>
          </div>
        )}
      </div>
    </div>
