    ...
    <main className="p-4 md:p-8 min-h-screen bg-[#f8f9fa]">
      ...
      {loading ? (
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 xl:grid-cols-[1fr_400px] gap-8 items-start">
          ...
          <div className="order-1 xl:order-1 bg-white border-l-4 border-l-orange-600 rounded-r-2xl shadow-xl border border-slate-200 flex flex-col h-[750px]">
          ...
          <div className="order-2 xl:order-2 bg-slate-100/50 border-2 border-slate-200 rounded-3xl p-4 md:p-8 overflow-auto h-[750px] shadow-inner relative">
