...
return ( <div className="container mx-auto py-10 px-4 sm:px-6 lg:px-8"> <h1 className="text-3xl font-bold mb-4">Événements ICT Toulouse</h1> <p className="text-muted-foreground mb-6">
Cette page affiche les 100 prochains événements culturels de l’ICT. </p>
