...
export default function GoogleTranslateCustom() {
  ...
  useEffect(() => {
    ...
    // NETTOYAGE AGRESSIF : On retire tout ce qui bloque les clics
    const interval = setInterval(() => {
      // On cible toutes les iframes Google Translate possibles
      ...
      frames.forEach((f) => {
        ...
        frame.style.pointerEvents = 'none'; // CRITIQUE : Permet de cliquer "à travers" l'iframe
      });
      
      // Reset du décalage de page
  ...
  return (
    <>
      <style jsx global>{`
        /* SUPPRESSION VISUELLE ET PHYSIQUE DE LA BARRE GOOGLE */
        ...
        .skiptranslate {
          ...
          pointer-events: none !important; /* Rend l'élément traversable par la souris */
        }
