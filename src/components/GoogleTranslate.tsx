...
{/* On passe de mt-10 à mt-32 (environ 128px de descente) */}
    <div className="google-translate-custom mt-22 mb-8 flex flex-col gap-2 w-full max-w-[320px] ml-auto p-3 bg-white rounded-xl shadow-md border border-slate-200 relative z-10">
