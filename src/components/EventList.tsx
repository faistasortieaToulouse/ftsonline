    ...
    <div className="container mx-auto px-4 py-8 md:py-12">
      ...
      {loading ? (
         <div className="flex flex-col items-center justify-center text-center py-20 px-4">
          ...
          <h2 className="font-headline text-2xl font-semibold text-foreground mb-2">Chargement des événements...</h2>
          <p className="text-muted-foreground">Nous rassemblons les dernières sorties pour vous.</p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center text-center py-20 px-4 rounded-lg border-2 border-dashed bg-card">
          <h2 className="font-headline text-2xl font-semibold text-foreground mb-2">Aucun événement trouvé</h2>
          <p className="text-muted-foreground mb-6">
            {searchTerm ? "Essayez de modifier votre recherche." : "Revenez plus tard pour de nouveaux événements !"}
          </p>
        </div>
      )}
    </div>
